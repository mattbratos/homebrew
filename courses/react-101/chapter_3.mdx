...
[getElementById()](https://developer.mozilla.org/en-US/docs/Web/API/Document/getElementById), to select the `<div>` element by its
`id`:
...
If you look at the DOM elements inside your [browser developer tools](https://developer.mozilla.org/docs/Learn/Common_questions/Tools_and_setup/What_are_browser_developer_tools) ,
...
elements and Source Code](https://vvlp2wl4yesgvvvr.public.blob.vercel-storage.com/vercel/react/learn-dom-and-source-vTUKz3wB6RPwXaSbFpMGrvFK7lCXST.webp)
