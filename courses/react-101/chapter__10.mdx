...
![Diagram showing a browser on the left and a server on the right, separated by a network boundary.](https://vvlp2wl4yesgvvvr.public.blob.vercel-storage.com/vercel/react/learn-client-and-server-environments-JYSbscjkcGXcmd2UBeEFc5l5edgWcJ.webp)
